...
//переделать без использования статик переменной
//static NSMutableArray *self.arrayOfEvents;
...
-(BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    SUNEvent *myEvent=[[SUNEvent alloc] initWithEventName: [NSString stringWithUTF8String:__PRETTY_FUNCTION__]];
    ...
    NSLog(@"%lu",self.arrayOfEvents.count);
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"%lu",(unsigned long)self.arrayOfEvents.count);
